        ...
        <SelectPrimitive.Trigger
            ...
            className={cn(
                ...
                *:data-[slot=select-value]:gap-2 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4
                ...
                dark:focus-visible:border-slate-300 dark:focus-visible:ring-slate-300/50 dark:aria-invalid:border-red-900
                hover:cursor-pointer bg-slate-100
                `,
                className
            )}
            {...props}
